...
public class MapCharacterCollision {
	...
	public static void Collision(OpenCog.Map.OCMap map, CharacterCollider collider) {
		for(int i=0; i<3; i++) {
	...
	private static Contact? GetClosestContact(OpenCog.Map.OCMap map, CharacterCollider collider) {
