...
public float ExplosiveForce = 300.0f;
...
void DestroyVoxels(int xPos, int yPos, int zPos, int range)
{
				...
				// Create cubes as children of this scene filter object
																...
																{	
																				...
																				{							
																								...
																								if(IsSurfaceVoxel(x, y, z))
																								{
																												...
																												cube.rigidbody.AddForce((explosionForce.normalized + up) * ExplosiveForce);
																								}
																				}
																}
												}
				...
				foreach(Vector3i voxel in voxelsToDelete)
